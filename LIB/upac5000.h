/*
Last Update at 2010/04/27 [yyyy/mm/dd] By Tim Tsai.
*/
#ifndef __MINIOS7__
#define __MINIOS7__
...
/*
 Functions for COM9(WITHOUT RTS/CTS)
*/
#define IsCom9		IsCom_9
#define ToCom9		ToCom_9
#define ToCom9Str	ToComStr_9
#define ToCom9Bufn	ToComBufn_9
#define printCom9	printCom_9
#define ClearTxBuffer9	ClearTxBuffer_9
#define SetCom9FifoTriggerLevel		SetComFifoTriggerLevel_9
#define SetBaudrate9	SetBaudrate_9
#define ReadCom9	ReadCom_9
#define ClearCom9	ClearCom_9
#define DataSizeInCom9  DataSizeInCom_9
#define WaitTransmitOver9	WaitTransmitOver_9
#define IsTxBufEmpty9		IsTxBufEmpty_9
#define IsCom9OutBufEmpty	IsComOutBufEmpty_9
#define ReadCom9n		ReadComn_9
#define SetDataFormat9		SetDataFormat_9
#define SetBreakMode9		SetBreakMode_9
#define SendBreak9		SendBreak_9
#define IsDetectBreak9		IsDetectBreak_9

int InstallCom_9(unsigned long baud, int data, int parity, int stop);
int RestoreCom_9(void);
int IsCom_9(void);
int ToCom_9(int data);
int ToComStr_9(char *str);
int ToComBufn_9(char *buf,int no);
int printCom_9(const char *fmt,...);
void ClearTxBuffer_9(void);
int GetTxBufferFreeSize_9(void);
int SetComFifoTriggerLevel_9(int level);
int SetBaudrate_9(unsigned long baud);
int ReadCom_9(void);
int ClearCom_9(void);
int DataSizeInCom_9(void);
int WaitTransmitOver_9(void);
int IsTxBufEmpty_9(void);
int IsComOutBufEmpty_9(void);
int SetDataFormat_9(int databit,int parity,int stopbit);
int ReadComn_9(unsigned char *buf,int n);
void SendBreak_9(unsigned timems);
void SetBreakMode_9(int mode);
int IsDetectBreak_9(void);
int GetTxBufferFreeSize_9(void);

void SetComPortBufferSize_9(int in_size,int out_size);
void InstallComInputData_9(int (*DoInputData)(unsigned char data));

/*
 Functions for COM10(WITHOUT RTS/CTS)
*/
#define IsCom10		IsCom_10
#define ToCom10		ToCom_10
#define ToCom10Str	ToComStr_10
#define ToCom10Bufn	ToComBufn_10
#define printCom10	printCom_10
#define ClearTxBuffer10	ClearTxBuffer_10
#define SetCom10FifoTriggerLevel		SetComFifoTriggerLevel_10
#define SetBaudrate10	SetBaudrate_10
#define ReadCom10	ReadCom_10
#define ClearCom10	ClearCom_10
#define DataSizeInCom10  DataSizeInCom_10
#define WaitTransmitOver10	WaitTransmitOver_10
#define IsTxBufEmpty10		IsTxBufEmpty_10
#define IsCom10OutBufEmpty	IsComOutBufEmpty_10
#define ReadCom10n		ReadComn_10
#define SetDataFormat10		SetDataFormat_10
#define SetBreakMode10		SetBreakMode_10
#define SendBreak10		SendBreak_10
#define IsDetectBreak10		IsDetectBreak_10

int InstallCom_10(unsigned long baud, int data, int parity, int stop);
int RestoreCom_10(void);
int IsCom_10(void);
int ToCom_10(int data);
int ToComStr_10(char *str);
int ToComBufn_10(char *buf,int no);
int printCom_10(const char *fmt,...);
void ClearTxBuffer_10(void);
int GetTxBufferFreeSize_10(void);
int SetComFifoTriggerLevel_10(int level);
int SetBaudrate_10(unsigned long baud);
int ReadCom_10(void);
int ClearCom_10(void);
int DataSizeInCom_10(void);
int WaitTransmitOver_10(void);
int IsTxBufEmpty_10(void);
int IsComOutBufEmpty_10(void);
int SetDataFormat_10(int databit,int parity,int stopbit);
int ReadComn_10(unsigned char *buf,int n);
void SendBreak_10(unsigned timems);
void SetBreakMode_10(int mode);
int IsDetectBreak_10(void);
int GetTxBufferFreeSize_10(void);

void SetComPortBufferSize_10(int in_size,int out_size);
void InstallComInputData_10(int (*DoInputData)(unsigned char data));
...
int XEE_MultiWrite_A(int StartBlock,int StartAddr,int no,char *databuf);
/*
...
*/
unsigned OS7_GetDiskStartSeg(int disk);
...
#define _OS7_GET_FILE_
FILE_DATA far *OS7_GetFirstFile(int disk,FILE_DATA far *fd);/* [2010/04/27] */
FILE_DATA far *OS7_GetNextFile(FILE_DATA far *fd);          /* [2010/04/27] */
...
/* [2010/09/21] GPRS_Reset() is removed.
void GPRS_Reset(void);
*/
void GPS_SetPower(int mode);
void GPS_Reset(void);

void COM_SetPower(int mode); /* [2011/08/23] for GM-1000 */
void XWB_SetPower(int mode); /* [2011/08/23] for GM-1000 */
/*
mode=1 --> Power ON
mode=0 --> Power OFF
*/
...
/*
	...
	Delay2_1() will use Timer 2. [2011/12/08] add  
*/
...
/*
	...
	Delay2_2() will use Timer 2. [2011/12/08] add 
*/
...
IO Expension bus
*/
#define TO_0_PIN	15	// 10 --> 15
#define TI_0_PIN	11
#define TO_1_PIN	1
#define TI_1_PIN	0

#define DIO_4_PIN 	4
#define DIO_9_PIN	12	// 9 --> 12
#define DIO_14_PIN	13	// 14 --> 13 
#define CLK_PIN		26
